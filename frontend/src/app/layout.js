...
export default function RootLayout({ children }) {
  return (
    ...
    >
      <head>
        {/* Anti-flash: apply landing dark mode before first paint */}
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{if(localStorage.getItem('landing-theme')==='dark')document.documentElement.classList.add('dark')}catch(e){}})()`,
          }}
        />
      </head>
