      ...
      <div className="container mx-auto px-4 max-w-5xl">
        <div className="bg-base-100 border border-base-300 rounded-xl p-6 space-y-8 shadow-xl">
          ...
          <div className="border-t border-base-300 pt-6">
            <h3 className="text-lg font-semibold text-base-content mb-3">Live Preview</h3>
                  ...
                  <div className="bg-base-100 rounded-xl shadow-sm overflow-hidden border border-base-300">
                    ...
                    <div className="p-4 border-t border-base-300 bg-base-100">
                      <div className="flex gap-2">
                        <input
                          type="text"
                          className="input input-bordered flex-1 text-sm h-10 bg-base-50 text-base-content"
